const getPlayer = async (jwt) => {
    ...
    return fetch("http://localhost:3001/player", {headers})
    .then(res => res.json())
}
...
const createPlayer = async (player, jwt) => {
    ...
    return fetch("http://localhost:3001/player", requestOptions)
...
const deletePlayer = async (player, jwt) => {
    ...
    return fetch("http://localhost:3001/player/" + player._id, requestOptions)
